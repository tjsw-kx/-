...
import com.graduation.config.CustomerLoginInterceptor;
import com.graduation.config.LoginInterceptor;
...
public class ShopmallApplication extends WebMvcConfigurerAdapter {
	 ...
	 * （2）覆盖方法：configureContentNegotiation favorPathExtension表示支持后缀匹配，
